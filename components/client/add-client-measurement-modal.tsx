...
import { addClientSelfMeasurementAction } from '@/app/client/my-progress/actions'

export function AddClientMeasurementModal() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      const res = await addClientSelfMeasurementAction(null, formData)
      if (res.success) {
        setSuccess(true)
        setTimeout(() => {
          setSuccess(false)
